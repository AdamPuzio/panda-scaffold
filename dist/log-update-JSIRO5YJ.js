...
var _chunkF7EIK6POjs = require('./chunk-F7EIK6PO.js');
...
function stringWidth(string, options = {}) {
  ...
  for (const { segment: character } of segmenter.segment(string)) {
    ...
    width += _chunkTNRZ3TSVjs.eastAsianWidth.call(void 0, codePoint, eastAsianWidthOptions);
  }
  return width;
}
...
function isFullwidthCodePoint(codePoint) {
  ...
  return _chunkTNRZ3TSVjs.eastAsianWidth.call(void 0, codePoint) === 2;
}
...
function createLogUpdate(stream, { showCursor = false } = {}) {
  ...
  const render = (...arguments_) => {
    if (!showCursor) {
      _chunkF7EIK6POjs.cli_cursor_default.hide();
    }
  ...
  render.done = () => {
    ...
    previousLineCount = 0;
    if (!showCursor) {
      _chunkF7EIK6POjs.cli_cursor_default.show();
    }
  };
  return render;
}
