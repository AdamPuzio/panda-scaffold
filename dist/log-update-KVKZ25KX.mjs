...
var isWindows = !isBrowser && process.platform === "win32";
...
var logUpdate = createLogUpdate(process2.stdout);
var log_update_default = logUpdate;
var logUpdateStderr = createLogUpdate(process2.stderr);
export {
  createLogUpdate,
